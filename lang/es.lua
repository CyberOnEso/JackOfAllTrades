...
-- Chat strings  --
-------------------------------------------------------------------------------------------------
SafeAddString(SI_JACK_OF_ALL_TRADES_METICULOUS_DISASSEMBLY_BENEFIT, "mejorar los resultados de refinamiento");
...
SafeAddString(SI_JACK_OF_ALL_TRADES_WARNING, "Aviso");
SafeAddString(SI_JACK_OF_ALL_TRADES_NOTIFICATION, "Notificación");
SafeAddString(SI_JACK_OF_ALL_TRADES_TEXT_COLOUR, "<<C:1>> color de texto");
SafeAddString(SI_JACK_OF_ALL_TRADES_DEBUG, "Debug");
SafeAddString(SI_JACK_OF_ALL_TRADES_ENABLE_MODE, "Habilitar modo <<z:1>>");
SafeAddString(SI_JACK_OF_ALL_TRADES_DEBUG_RESET, "Reiniciar variables guardadas");
SafeAddString(SI_JACK_OF_ALL_TRADES_DEBUG_RESET_SKILLS, "Reiniciar data de habilidades anterior");
-------------------------------------------------------------------------------------------------
...
SafeAddString(SI_JACK_OF_ALL_TRADES_INTERACT_COLLECT, "Recolectar");
SafeAddString(SI_JACK_OF_ALL_TRADES_INTERACT_HARVEST, "Recolectar");
SafeAddString(SI_JACK_OF_ALL_TRADES_INTERACT_LOOT, "Robar");
...
SafeAddString(SI_JACK_OF_ALL_TRADES_INTERACT_SEARCH, "Robar");
